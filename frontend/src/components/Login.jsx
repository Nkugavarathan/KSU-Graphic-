...
//   //   try {
//   //     const response = await axios.post(
//   //       "https://ksugraphicmyadmin.infinityfreeapp.com/login.php",
//   //       { username, password },
...
//   //     if (data.status === "success") {
//   //       localStorage.setItem("isAdmin", "true") // Set login flag in localStorage
//   //       setVariant("success")
//   //       setMessage("Admin Login Successful!")
//   //       setIsAdmin(true) // Update UI to show admin features
//   //     } else {
//   //       setVariant("danger")
//   //       setMessage(data.message || "Something went wrong. Try again.")
//   //       setIsAdmin(false)
...
//       }
//     } catch (error) {
//       console.error("LOGIN FAIL MESSAGE:", error.message)
//       setVariant("danger")
...
//   const handleLogout = () => {
//     localStorage.removeItem("isAdmin") // Remove login flag from localStorage
//     setIsAdmin(false) // Hide admin features
//     setMessage("You have logged out.")
//   }
...
//       {/* Show "Add Work" button and "Logout" only if admin is logged in */}
//       {isAdmin && (
//         <Row className="mt-4 mx-5">
//           <Col className="text-center">
//             <Button variant="success" size="lg" onClick={handleOpenModal}>
